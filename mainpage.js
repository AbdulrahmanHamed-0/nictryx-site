...
// Initialize mobile menu functionality
        function initializeMobileMenu() {
            ...
            function openMobileMenu() {
                ...
                // 🔒 lock page scroll on both body + html
        ...
        function generateMatrixRain() {
            ...
            const characters = '0101101010011110100010010101010100010101101111010101101';
        ...
        //     // Disabled particle generation (might need it later)
        ...
        generateMatrixRain();
        // generateParticles(); // disabled (might need it later)
        // generateDataStreams(); // disabled (might need it later)
                    ...
                    if (window.innerWidth > 768) {
                        ...
                        particles.forEach(particle => {
                            ...
                            if (distance < 150) {
                                ...
                                particle.style.boxShadow = `0 0 ${20 + brightness * 30}px rgba(255, 255, 255, ${0.35 + brightness * 0.4})`;
        ...
        // Navbar scroll effect (Sunset Neon gradient)
        window.addEventListener('scroll', () => {
            const nav = document.querySelector('nav');
            const gradient = 'linear-gradient(135deg, #ff2d95, #af2fff)';
        ...
        document.querySelectorAll('.btn-primary, .btn-secondary').forEach(button => {
            button.addEventListener('mouseenter', function() {
                this.style.boxShadow = '0 0 30px rgba(255, 255, 255, 0.45)';
            });
      ...
      //   const cyberTexts = [ 'ART', 'Animation', 'EDITS'];
...
document.querySelectorAll('a[href^="http"]').forEach(link => {
    // skip if you ever have external links you *don't* want in new tab
    link.setAttribute('target', '_blank');
    link.setAttribute('rel', 'noopener noreferrer');
  });

        // Contact form submission
        // Web3Forms AJAX submit for contact form (no redirect)
const contactForm = document.getElementById('contactForm');
const submitBtn = contactForm ? contactForm.querySelector('.btn-submit') : null;
const resultEl = document.getElementById('form-result');

if (contactForm && submitBtn && resultEl) {
  contactForm.addEventListener('submit', async (e) => {
    e.preventDefault(); // stay on the same page

    // Let browser show built‑in validation errors if any
    ...
    try {
      ...
      if (response.ok) {
        ...
        resultEl.textContent = data.message || 'Message sent successfully.';
        contactForm.reset();
      } else {
    ...
    // After 3s, reset button back to normal
    setTimeout(() => {
